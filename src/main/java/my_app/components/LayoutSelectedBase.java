...
public class LayoutSelectedBase extends VBox {
    final ObjectProperty<Node> selectedNode;

    public LayoutSelectedBase(ObjectProperty<Node> selectedNode) {
        this.selectedNode = selectedNode;
    }

    public void renderTextOptions() {
        ...
        this.getChildren().add(fontSizeItem);
        ...
        this.getChildren().add(fontWeightItem);
        ...
        this.getChildren().add(fontColorItem);

        updateUi(tf, combo, colorPicker);
    }

    public void updateUi(TextField tf, ComboBox<String> combo, ColorPicker colorPicker) {
        // atualizando a ui
